...
{{
var G__14153 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14153;
continue;
}
} else
...
{var pred__14157 = cljs.core._EQ_;var expr__14158 = limit;if(cljs.core.truth_(pred__14157.call(null,1,expr__14158)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14157.call(null,2,expr__14158)))
...
var G__14160 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14161 = (limit__$1 - 1);
var G__14162 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14160;
limit__$1 = G__14161;
parts = G__14162;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14164 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14164))
{var replacement_14165 = temp__4090__auto___14164;buffer.append([cljs.core.str(replacement_14165)].join(''));
} else
{buffer.append(ch);
}
{
var G__14166 = (index + 1);
index = G__14166;
continue;
}
}
