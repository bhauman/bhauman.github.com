...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13974 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13974 = (function (val,box,meta13975){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13974.cljs$lang$type = true;
cljs.core.async.impl.channels.t13974.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13974";
cljs.core.async.impl.channels.t13974.cljs$lang$ctorPrWriter = (function (this__3984__auto__,writer__3985__auto__,opt__3986__auto__){return cljs.core._write.call(null,writer__3985__auto__,"cljs.core.async.impl.channels/t13974");
});
cljs.core.async.impl.channels.t13974.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13974.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13976){var self__ = this;
var _13976__$1 = this;return self__.meta13975;
});
cljs.core.async.impl.channels.t13974.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13976,meta13975__$1){var self__ = this;
var _13976__$1 = this;return (new cljs.core.async.impl.channels.t13974(self__.val,self__.box,meta13975__$1));
});
cljs.core.async.impl.channels.__GT_t13974 = (function __GT_t13974(val__$1,box__$1,meta13975){return (new cljs.core.async.impl.channels.t13974(val__$1,box__$1,meta13975));
});
}
return (new cljs.core.async.impl.channels.t13974(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__3987__auto__,writer__3988__auto__,opts__3989__auto__){return cljs.core._write.call(null,writer__3988__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__3984__auto__,writer__3985__auto__,opt__3986__auto__){return cljs.core._write.call(null,writer__3985__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_13977 = self__.takes.pop();if((taker_13977 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13977))
{var take_cb_13978 = cljs.core.async.impl.protocols.commit.call(null,taker_13977);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13978,taker_13977){
return (function (){return take_cb_13978.call(null,null);
});})(take_cb_13978,taker_13977))
);
} else
{}
{
