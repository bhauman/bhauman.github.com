...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13968 = 0;while(true){
var m_13969 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13969 == null))
{} else
{m_13969.call(null);
if((count_13968 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13970 = (count_13968 + 1);
count_13968 = G__13970;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3410__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3410__auto__)
